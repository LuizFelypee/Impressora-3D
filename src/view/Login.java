...
public class Login extends JFrame {
	...
	public Login() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/img/impressora 3D.png")));
		setTitle("Impressora 3D - Login");
		setResizable(false);
	 ...
	 */
	private void logar() {
		//variavel usada para captura segura de senhas
			...
			try {
				...
				if (rs.next()) {
					...
					if (perfil.equals("admin")) {
    					...
    					//a linha abaixo muda o texto do jlabel (lblstatus) da tela principal pelo nome do usuário

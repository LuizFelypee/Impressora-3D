...
public class Tecnicos extends JDialog {
	...
	public Tecnicos() {
		...
		setModal(true);
		setTitle("Impressora 3D - Tecnicos");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Tecnicos.class.getResource("/img/impressora fundo.png")));
		...
		btnCreate.setIcon(new ImageIcon(Tecnicos.class.getResource("/img/create.png")));
		btnCreate.setBounds(8, 271, 50, 48);
		...
		btnLimpar.setIcon(new ImageIcon(Tecnicos.class.getResource("/img/clear.png")));
		btnLimpar.setBounds(453, 271, 48, 48);
		...
		btnUpdate.setIcon(new ImageIcon(Tecnicos.class.getResource("/img/update.png")));
		btnUpdate.setBounds(69, 269, 50, 50);
		...
		btnDelete.setIcon(new ImageIcon(Tecnicos.class.getResource("/img/delete.png")));
		btnDelete.setBounds(129, 271, 50, 50);
		contentPanel.add(btnDelete);
		
		lblNewLabel_2 = new JLabel("Fone");
		lblNewLabel_2.setBounds(12, 167, 46, 14);
		contentPanel.add(lblNewLabel_2);
		
		txtFone = new JTextField();
		txtFone.setColumns(10);
		txtFone.setBounds(81, 165, 150, 17);
